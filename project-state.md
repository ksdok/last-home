...
- ✅ **LH-21** delivered: `drawStockArrow` and `Events.OnPostUIDraw.Add(drawStockArrow)` were removed from `LastHomeClient.lua`; the ground stock data (`stockSpawn` / `supply` / `getHouseStockSpawn`) and the rest of the HUD stay unchanged
